...
const initialSources: Source[] = [
    {
        color: 0,
        label: "Wikidata",
        url: "https://www.wikidata.org/wiki/Q52154015",
        snippet:
            "No description defined.",
        deleted: false,
        singleValues: {
            name: "Fabritius Bassecourt",
            dateOfBirth: "1578-09-21",
            dateOfDeath: "1650-04-29",
    ...
    {
        color: 1,
        label: "Category:Fabrice de la Bassecourt - Wikimedia Commons",
        url: "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt",
        snippet:
            "Fabrice de la Bassecourt or Fabricius Bassecourtius (1578—1650), educated as a catholic priest, Calvinist minister in Metz in 1607, ...",
        deleted: false,
        singleValues: {
            name: "Fabrice de la Bassecourt",
            dateOfBirth: "1578",
            dateOfDeath: "1650",
            floruitStart: undefined,
            floruitEnd: undefined,
        ...
        multiValues: {
            country: ["Belgium"],
            occupation: ["catholic priest", "Calvinist minister"],
            instanceOf: ["human", "alien"],
        },
    },
    {
        color: 2,
        ...
        url: "original",
        snippet: "Original entry in the database sourced from MET.",
        deleted: false,
        singleValues: {
            name: "Fabritius Bassecourt",
...
export const initialSingleValueSourceMap: { [key in SingleValue]: string } = {
    name: "https://www.wikidata.org/wiki/Q52154015",
    dateOfBirth: "https://www.wikidata.org/wiki/Q52154015",
    dateOfDeath: "https://www.wikidata.org/wiki/Q52154015",
    floruitStart: "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt",
    floruitEnd: "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt",
}

export const initialMultiValueSourceMap: { [key in MultiValue]: { [key: string]: number }[] } = {
    gender: [{ "https://www.wikidata.org/wiki/Q52154015": 0 }],
    country: [{ "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt": 0 }],
    occupation: [{ "original": 0 }],
    instanceOf: [{ "https://www.wikidata.org/wiki/Q52154015": 0 }, { "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt": 1 }],
}

export const initialValueSourceRankMap: { [key in SingleValue | MultiValue]: string[] } = {
    name: ["https://www.wikidata.org/wiki/Q52154015", "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt", "original"],
    gender: ["https://www.wikidata.org/wiki/Q52154015", "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt", "original"],
    dateOfBirth: ["https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt", "https://www.wikidata.org/wiki/Q52154015", "original"],
    dateOfDeath: ["https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt", "https://www.wikidata.org/wiki/Q52154015", "original"],
    floruitStart: ["https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt", "https://www.wikidata.org/wiki/Q52154015", "original"],
    floruitEnd: ["https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt", "https://www.wikidata.org/wiki/Q52154015", "original"],
    country: ["https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt", "https://www.wikidata.org/wiki/Q52154015", "original"],
    occupation: ["original", "https://www.wikidata.org/wiki/Q52154015", "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt"],
    instanceOf: ["https://www.wikidata.org/wiki/Q52154015", "https://commons.wikimedia.org/wiki/Category:Fabrice_de_la_Bassecourt", "original"],
}
